...
def pull_fence_distance():
    try:
        ...
        cam_config = {
            ...
            'hardware': {'focal_length_mm': 0.234, 'sensor_width_mm': 36},
        ...
        print("---------------------人的经纬度--------------------")
        print("person_lat: ", person_lat)
        print("person_lng: ", person_lng)
        print("fence_coords: ", fence_coords)
        # 7. 计算距离
        ...
        print("distance_to_fence: ", distance_to_fence)
        result_data = {
            "dev_id": dev_id,
